...
class TodoList(models.Model):
	...
	created = models.DateField(default=timezone.now().strftime("%d-%m-%Y")) # дата создания
	due_date = models.DateField(default=timezone.now().strftime("%d-%m-%Y")) #до какой даты нужно было сделать дело
